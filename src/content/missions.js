...
export const MISSIONS = {
  peau: {
    ...
    missions: [
      { id: 'sommet', type: 'reach', spot: 'poil', r: 150, short: 'Sommet du poil', label: { e: 'Monte au sommet du grand poil', a: 'Rejoindre le sommet du grand poil' } },
      { id: 'pore', type: 'read', spot: 'pore', short: 'Le pore', label: { e: 'Va voir d’où sort la sueur', a: 'Ouvrir la fiche du pore' } },
      { id: 'recolte', type: 'collect', n: 7, short: 'Récolte', label: { e: 'Ramasse 7 grains de poussière', a: 'Prélever 7 squames' } },
    ],
    relic: {
  ...
  sang: {
    ...
    missions: [
      { id: 'paroi', type: 'reach', spot: 'paroi', r: 40, short: 'La paroi', label: { e: 'Va toucher le mur du tuyau', a: 'Approcher la paroi du vaisseau' } },
      { id: 'quiz', type: 'quiz', short: 'La question', label: { e: 'Réponds à la question de l’escale', a: 'Répondre à la question de l’escale' } },
      { id: 'recolte', type: 'collect', n: 8, short: 'Récolte', label: { e: 'Attrape 8 bulles d’oxygène', a: 'Capter 8 molécules d’oxygène' } },
    ],
    relic: {
      ...
      html: {
        ...
        a: '<p>Un bouchon de plaquettes prises dans un filet de fibres. C’est ce qui arrête un saignement. Formé au mauvais endroit, c’est exactement ce qui bouche une artère.</p>',
      },
    },
  },
  ...
  coeur: {
    ...
    missions: [
      { id: 'valve', type: 'reach', spot: 'valve', r: 130, short: 'La porte d’entrée', label: { e: 'Va sous la grande porte d’entrée', a: 'Se placer sous la valve d’entrée' } },
      { id: 'aorte', type: 'read', spot: 'aorte', short: 'La porte de sortie', label: { e: 'Trouve par où le sang ressort', a: 'Ouvrir la fiche de la valve de sortie' } },
      { id: 'recolte', type: 'collect', n: 6, short: 'Récolte', label: { e: 'Suis 6 gouttes de sang', a: 'Suivre 6 volumes éjectés' } },
    ],
    relic: {
  ...
  poumons: {
    ...
    missions: [
      { id: 'alveole', type: 'reach', spot: 'alveole', r: 230, short: 'Le sac d’air', label: { e: 'Entre dans le grand sac d’air', a: 'Entrer dans le sac alvéolaire' } },
      { id: 'capillaire', type: 'read', spot: 'capillaire', short: 'Le capillaire', label: { e: 'Regarde le tuyau rouge autour', a: 'Ouvrir la fiche du capillaire' } },
      { id: 'recolte', type: 'collect', n: 8, short: 'Récolte', label: { e: 'Attrape 8 bulles d’air', a: 'Capter 8 bouffées d’air' } },
    ],
    relic: {
  ...
  estomac: {
    ...
    missions: [
      { id: 'acide', type: 'reach', spot: 'acide', r: 130, short: 'Les puits à acide', label: { e: 'Trouve d’où sort l’acide', a: 'Trouver le champ de puits à acide' } },
      { id: 'mucus', type: 'read', spot: 'mucus', short: 'Le mucus', label: { e: 'Découvre le bouclier gluant', a: 'Ouvrir la fiche du mucus' } },
      { id: 'recolte', type: 'collect', n: 7, short: 'Récolte', label: { e: 'Ramasse 7 morceaux de repas', a: 'Prélever 7 fragments' } },
    ],
    relic: {
  ...
  intestin: {
    ...
    missions: [
      { id: 'villosite', type: 'reach', spot: 'villosite', r: 90, short: 'La villosité', label: { e: 'Approche le grand doigt', a: 'Approcher la grande villosité' } },
      { id: 'microbiote', type: 'read', spot: 'microbiote', short: 'La colonie', label: { e: 'Rencontre tes bactéries', a: 'Ouvrir la fiche du microbiote' } },
      { id: 'recolte', type: 'collect', n: 8, short: 'Récolte', label: { e: 'Attrape 8 nutriments', a: 'Capter 8 nutriments' } },
    ],
    relic: {
  ...
  foie: {
    ...
    missions: [
      { id: 'lobule', type: 'reach', spot: 'lobule', r: 140, short: 'Le module', label: { e: 'Entre dans un atelier hexagonal', a: 'Entrer dans un lobule' } },
      { id: 'bile', type: 'read', spot: 'bile', short: 'La bile', label: { e: 'Trouve le liquide vert', a: 'Ouvrir la fiche de la bile' } },
      { id: 'recolte', type: 'collect', n: 7, short: 'Récolte', label: { e: 'Nettoie 7 toxines', a: 'Traiter 7 molécules' } },
    ],
    relic: {
      ...
      html: {
        ...
        a: '<p>Le seul organe humain qui se régénère vraiment. Amputé de deux tiers, il retrouve sa masse en quelques semaines, et c’est ce qui rend possible le don de foie entre vivants. La forme d’origine, elle, ne revient pas.</p>',
      },
    },
  },
  ...
  rein: {
    ...
    missions: [
      { id: 'glomerule', type: 'reach', spot: 'glomerule', r: 150, short: 'Le filtre', label: { e: 'Approche la pelote de tuyaux', a: 'Approcher le glomérule' } },
      { id: 'henle', type: 'read', spot: 'henle', short: 'L’épingle', label: { e: 'Suis le grand virage', a: 'Ouvrir la fiche de l’anse' } },
      { id: 'recolte', type: 'collect', n: 7, short: 'Récolte', label: { e: 'Filtre 7 déchets', a: 'Filtrer 7 déchets' } },
    ],
    relic: {
  ...
  charpente: {
    ...
    missions: [
      { id: 'moelle', type: 'reach', spot: 'moelle', r: 200, short: 'La moelle', label: { e: 'Va voir l’usine à sang', a: 'Rejoindre la moelle' } },
      { id: 'fibre', type: 'read', spot: 'fibre', short: 'La fibre', label: { e: 'Découvre comment un muscle tire', a: 'Ouvrir la fiche de la fibre' } },
      { id: 'recolte', type: 'collect', n: 7, short: 'Récolte', label: { e: 'Récolte 7 cristaux', a: 'Prélever 7 cristaux' } },
    ],
    relic: {
  ...
  cerveau: {
    ...
    missions: [
      { id: 'neurone', type: 'reach', spot: 'neurone', r: 220, short: 'Le neurone', label: { e: 'Approche le corps d’un neurone', a: 'Approcher un corps cellulaire' } },
      { id: 'synapse', type: 'read', spot: 'synapse', short: 'La synapse', label: { e: 'Regarde comment deux neurones se parlent', a: 'Ouvrir la fiche de la synapse' } },
      { id: 'recolte', type: 'collect', n: 8, short: 'Récolte', label: { e: 'Attrape 8 messages', a: 'Capter 8 influx' } },
    ],
    relic: {
      title: { e: 'Le souvenir', a: 'La trace mnésique' },
      html: {
        e: '<p>Un souvenir n’est pas rangé quelque part comme un fichier. C’est un groupe de neurones qui ont pris l’habitude de s’allumer ensemble. Se souvenir, c’est les rallumer, et chaque rappel les modifie un peu.</p>',
  ...
  cellule: {
    ...
    missions: [
      { id: 'adn', type: 'reach', spot: 'adn', r: 190, short: 'L’ADN', label: { e: 'Approche la grande échelle torsadée', a: 'Approcher la double hélice' } },
      { id: 'mito', type: 'read', spot: 'mito', short: 'La centrale', label: { e: 'Trouve la centrale électrique', a: 'Ouvrir la fiche de la mitochondrie' } },
      { id: 'recolte', type: 'collect', n: 8, short: 'Récolte', label: { e: 'Ramasse 8 briques', a: 'Prélever 8 acides aminés' } },
    ],
    relic: {
